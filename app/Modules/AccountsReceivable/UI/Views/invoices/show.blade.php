<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{{ __('Invoice') }} {{ $invoice->invoice_number }}</h2>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($invoice->adjustments as $adj)
                            <tr>
                                ...
                                <td class="px-4 py-2 text-gray-600 dark:text-gray-300">{{ $adj->reason ?? '&mdash;' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
